                ...
                <div class="md-card-content">
                    <div class="uk-grid" data-uk-grid-margin="">
                        <div class="uk-width-medium-8-10 uk-row-first">
                            <h3 class="heading_a">Add Category</h3>
                        </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-2">
                            <div class="uk-form-row">
                                ...
                                <input type="text" class="md-input validate[required]" value="" name="data[Productcategory][name]" value="<?php echo (!empty($this->request->data['Productcategory']['name'])) ? $this->request->data['Productcategory']['name'] : "" ?>"/>
                            </div>
                        </div>
