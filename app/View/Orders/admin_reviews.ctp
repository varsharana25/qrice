                    ...
                    <table id="dt_individual_search" class="uk-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php foreach ($reviews as $review) { ?>
                                <tr>
                                    <td data-title="Customer Id"><?php echo $review["Review"]['user_id'] + 1000; ?></td>
                                    <td data-title="Customer Name"><?php echo $user["Review"]['name']; ?></td>
                                    <td data-title="Order Id"><?php echo $review["Review"]['orderid']; ?></td>
                                    <td data-title="Rating"><?php echo $review["Review"]['rating']; ?>/5</td>
                                    <td data-title="Review" class="off-desc"><?php echo $review["Review"]['review']; ?></td>
