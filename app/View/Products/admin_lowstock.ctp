            ...
            <div class="md-card-content clearfix">
                <div class="uk-grid" data-uk-grid-margin="" data-uk-grid-match="{target:'.md-card'}">
                    <div class="uk-width-medium-8-10 uk-row-first">
                        <h3 class="heading_a">Low Stock Product List</h3>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            foreach ($products as $product) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo BASE_URL; ?>admin/products/view/<?php echo $product['Product']['product_id'] ?>?stock=low"><i class="md-icon material-icons">visibility</i></a>
                                        <a href="<?php echo BASE_URL; ?>admin/products/edit/<?php echo $product['Product']['product_id'] ?>?stock=low"><i class="md-icon material-icons">&#xE254;</i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
