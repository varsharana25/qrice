 ...
 *
 */
Configure::write('Routing.prefixes', array('admin', 'employee', 'superadmin'));
 ...
 */
Configure::write('Security.salt', 'ProjectManagementLynchpin');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
Configure::write('Security.cipherSeed', '653298562417862535');
